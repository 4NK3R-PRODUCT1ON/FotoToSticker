        ...
        case 'stiker': {
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                client.sendImageAsSticker(from, imageBase64).then(() => {
                    client.reply(from, 'Terimakasih telah menggunakan bot saya😊')
                ...
                */
                ...
                client.sendStickerfromUrl(from, url).then((r) => (!r && r !== undefined)
                    ...
                    : client.reply(from, 'Terimakasih telah menggunakan bot saya😊')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
            } else {
